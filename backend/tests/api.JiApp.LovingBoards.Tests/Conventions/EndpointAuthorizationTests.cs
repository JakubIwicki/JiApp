...
public sealed class EndpointAuthorizationTests
{
	...
	{
		private readonly WebApplicationFactory<api.JiApp.LovingBoards.Program> _factory;

		public Fixture()
		{
			_factory = new WebApplicationFactory<api.JiApp.LovingBoards.Program>()
	...
	public void AllEndpoints_RequireAuthorization_UnlessExplicitlyAllowed()
	{
		...
		// - /api/v1/lovingboards/health — load-balancer health probe.
		var allowList = new HashSet<string>(StringComparer.OrdinalIgnoreCase)
		{
			"api/v1/lovingboards/health"
		};
