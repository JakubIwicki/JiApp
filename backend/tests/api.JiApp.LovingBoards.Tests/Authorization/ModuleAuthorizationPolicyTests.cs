...
{
    private const string PolicyName = "module:LovingBoards";
        ...
        public Fixture()
        {
            ...
            services.AddAuthorizationBuilder()
                .AddPolicy(PolicyName, policy =>
                    policy.RequireClaim("module", Modules.LovingBoards));
    ...
    [Fact]
    public async Task Policy_AllowsUser_HoldingLovingBoardsModuleClaim()
    {
        var fixture = Fixture.Init();
        var user = Fixture.UserWithClaims(
            new Claim(ClaimTypes.NameIdentifier, "42"),
            new Claim("module", Modules.LovingBoards));
