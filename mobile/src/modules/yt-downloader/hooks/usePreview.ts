// NOTE: A simpler version exists at ../../../hooks/usePreview.ts without TrackPlayer error handling or UI-flicker prevention.
...
const usePreview = (): UsePreviewResult => {
  ...
  const play = useCallback(async (videoId: string) => {
    ...
    // finally — isLoading stays true until playback state confirms Playing
